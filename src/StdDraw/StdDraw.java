package StdDraw; /******************************************************************************
 *  Compilation:  javac StdDraw.StdDraw.java
 *  Execution:    java StdDraw.StdDraw
 *  Dependencies: none
 *
...
/**
 * The {@code StdDraw.StdDraw} class provides a basic capability for
 * creating drawings with your programs. It uses a simple graphics model that
 ...
 * <p>
 * <b>Getting started.</b>
 * To use this class, you must have {@code StdDraw.StdDraw.class} in your
 * Java classpath. If you used our autoinstaller, you should be all set.
 * Otherwise, either download
 * <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 * and add to your Java classpath or download
 * <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">StdDraw.StdDraw.java</a>
 ...
 *           StdDraw.StdDraw.setPenRadius(0.05);
 *           StdDraw.StdDraw.setPenColor(StdDraw.StdDraw.BLUE);
 *           StdDraw.StdDraw.point(0.5, 0.5);
 *           StdDraw.StdDraw.setPenColor(StdDraw.StdDraw.MAGENTA);
 *           StdDraw.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 * The methods {@code StdDraw.StdDraw.line()} and {@code StdDraw.StdDraw.point()}
 * draw lines and points; the methods {@code StdDraw.StdDraw.setPenRadius()}
 * and {@code StdDraw.StdDraw.setPenColor()} control the line thickness and color.
 * <p>
 ...
 * and represented in degrees. For example, {@code StdDraw.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  StdDraw.StdDraw.filledPolygon(x, y);
 * </pre>
 * p>
 * <b>Pen size.</b>
 ...
 * </ul>
 * p>
 * For example, {@code StdDraw.StdDraw.setPenRadius(0.025)} makes
 ...
 * For example, {@code StdDraw.StdDraw.setPenColor(StdDraw.StdDraw.MAGENTA)} sets the
 ...
 * For example, {@code StdDraw.StdDraw.setCanvasSize(800, 800)}
 ...
 * leave a small margin, you can call {@code StdDraw.StdDraw.setScale(-.05, 1.05)}.
 * p>
 ...
 *  StdDraw.StdDraw.setFont(font);
 *  StdDraw.StdDraw.text(0.5, 0.5, "Hello, World");
 * </pre>
 * p>
 * <b>Images.</b>
 ...
 * {@code StdDraw.StdDraw.clear(StdDraw.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 * of gray.
 * p>
 ...
 * <pre>
 *  StdDraw.StdDraw.setScale(-2, +2);
 *  StdDraw.StdDraw.enableDoubleBuffering();
 *
 *  for (double t = 0.0; true; t += 0.02) {
 *      double x = Math.sin(t);
 *      double y = Math.cos(t);
 *      StdDraw.StdDraw.clear();
 *      StdDraw.StdDraw.filledCircle(x, y, 0.05);
 *      StdDraw.StdDraw.filledCircle(-x, -y, 0.05);
 *      StdDraw.StdDraw.show();
 *      StdDraw.StdDraw.pause(20);
 *  }
 * </pre>
 * p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // One of x randomly selected colors
    public static final ArrayList<Color> colorToGroup = new ArrayList<>();
    ...
    private static void init() {
        ...
        frame.setTitle("Standard Draw window by Fin");
     ...
     * {@code StdDraw.StdDraw.BLACK}, {@code StdDraw.StdDraw.BLUE}, {@code StdDraw.StdDraw.CYAN},
     * {@code StdDraw.StdDraw.DARK_GRAY}, {@code StdDraw.StdDraw.GRAY}, {@code StdDraw.StdDraw.GREEN},
     * {@code StdDraw.StdDraw.LIGHT_GRAY}, {@code StdDraw.StdDraw.MAGENTA}, {@code StdDraw.StdDraw.ORANGE},
     * {@code StdDraw.StdDraw.PINK}, {@code StdDraw.StdDraw.RED}, {@code StdDraw.StdDraw.WHITE}, and
     * {@code StdDraw.StdDraw.YELLOW}.
     *
    ...
    /**
     * Sets the pen color to a color randomly selected from the ArrayList colorToGroup.
     */
    public static void setRandomPenColor() {
        if (!(colorToGroup.size() == 0)) {
            Collections.shuffle(colorToGroup);
            setPenColor(colorToGroup.get((int) Math.random()));
        }
    }
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to StdDraw.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to StdDraw.StdDraw)
        try {
            URL url = StdDraw.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
