...
public class Kon  // =Konsole  //extends Thread // Con = registrierter Dateiname
{
    ...
    // Zeichen für Sonder-Prompt - Cursor bleibt an der Eingabestelle (Ansi.sys)
    final private static String AT = "@";
    // Default-Zeichen für Fehler-Prompt - erscheint bei Falsch-Eingabe
    ...
    /**
     * MAX... liefert den größten Wert des DatenTyps.
     */
     ...
     * End of TeXt (3)
     */
    final public static String ETX = "" + (char) 3;    //"\003";  \0 ... \377 (=255)  C-Kompatibilität
    /**
     * BEEP (7)
     */
...
//   /** 1 Euro: FRF = 6.55957f (Französische France) */
...
//   /** 1 Euro: NLG = 2.20371f (Niederländische Gulden) */
//   final public static float  NLG = 2.20371f;
//   /** 1 Euro: ATS = 13.7603f (Österreichische Schilling) */
...
//
    ...
    public static String setCodePage(String cp) {
        if (cp.equalsIgnoreCase("Win")) {
            codePage = "Cp1252";
        }  // Latin1
        else if (cp.equalsIgnoreCase("Windows")) {
            codePage = "Cp1252";
        }  // Latin1
        else if (cp.equalsIgnoreCase("Dos")) {
            codePage = "Cp850";
        }  // Latin1
        else {
            codePage = cp;
     ...
     */
    public static String setPrompt(String s) {
        errP = s;
        return "";
    }
     ...
     */
    public static String readMenuModeOn() {
        setPrompt(AT);
        return "";
    }
     ...
     */
    public static String readMenuModeOff() {
        setPrompt(ERRP);
        return "";
    }
        ...
        try {
            ...
            while (inputString.equals("")) {  // Wiederhole bis was eingegeben wurde.
                ...
                if (errP.equals(AT)) {
                    ...
                    println("<Ctrl+C>=Cancel\n");
                }
                if (errP.equals(AT)) {
                    ansiRestoreCursor();
                    ansiClrEol();
                    inputString = readString(s);
                } else {
                    inputString = readString(s + errP);
    ...
    public static String readString(String s, String list) {
        ...
        if ((list.length() == 0) || (list.equals(","))) {
            return "";
        }
        if (list.charAt(list.length() - 1) != ',') {
            list = list + ",";
        }  // falls, am list-Ende vergessen wird!
        while (!list.contains(eingabe + ",")) {
            readOK = false;
            eingabe = readString(s);
        }
        readOK = true;
        println(eingabe);
        return eingabe;
    ...
    public static String[] readStringArray(String s) {
        ...
        for (int i = 0; i < strArr.length; i++) {
            strArr[i] = tk.nextToken();
        } //while ( tk.hasMoreTokens() )
        return strArr;
    }

    /**
     * Text in Token/Worte zerlegen und im String-Array zurückgeben.
     * Separatoren: "\r \t \n "
     */
    ...
    /**
     * text in Token/Worte zerlegen und im String-Array zurückgeben.
     * Seperatoren/Trennzeichen können angegeben werden.
     */
    public static String[] textToStringArray(String text, String seperators) {
        if (text == null || seperators == null) {
            return null;
        }
    ...
    public static String readEnter(String s) {
        ...
        try {
            ...
            print(s);
            reader1.readLine();  //reader1.close();
        } catch (Exception e) { /*nix*/ }
     ...
     * Akzeptierte Eingaben für true :  True   Wahr    Ja    J  Yes  Y  1 <BR>
     * Akzeptierte Eingaben für false:  False  Falsch  Nein  N  No   N  0
     */
    ...
    public static boolean readBoolean(String s, String wahr, String falsch) {
        String st = readString(s);
        if ((wahr.length() == 0) || (falsch.length() == 0)) {
            System.exit(2);
        }
        if (st.equalsIgnoreCase(wahr)) {
            return true;
        } else if (st.equalsIgnoreCase(falsch)) {
            return false;
        } else {
            return readBoolean(s + errP, wahr, falsch);
        }  // Eing. wiederholen
    }
    ...
    public static short readShort(String s) {
        try {
            return Short.parseShort(readString(s));
        } catch (NumberFormatException e) {
            max(new Short("0"));
            return readShort(s + errP);
        }
    }
    ...
    private static void max(Object o) {
        ...
        if (o instanceof Byte) {
            println("[" + (MIN_BYTE) + " ... " + (MAX_BYTE) + "]");
        } else if (o instanceof Short) {
            println("[" + (MIN_SHORT) + " ... " + (MAX_SHORT) + "]");
        } else if (o instanceof Integer) {
            println("[" + (MIN_INT) + " ... " + (MAX_INT) + "]");
        } else if (o instanceof Long) {
            println("[" + (MIN_LONG) + " ... " + (MAX_LONG) + "]");
        } else if (o instanceof Float) {
            println("[-3.4E+38 ... 3.4E+38]");
        }  //" + (Float.MIN_VALUE)   + ".." + (Float.MAX_VALUE)   + "]"); }
        else if (o instanceof Double) {
            println("[-1.79E+308 ... 1.79E+308]");
     ...
     */
    public static void print(String tar, char c) {
        prinT(tar, c + "");
    }

    public static void println(String tar, char c) {
        prinT(tar, c + CRLF);
    }
    ...
    public static void print(String tar, long l) {
        prinT(tar, l + "");
    }

    public static void println(String tar, long l) {
        prinT(tar, l + CRLF);
    }

    public static void print(String tar, double d) {
        prinT(tar, d + "");
    }

    public static void println(String tar, double d) {
        prinT(tar, d + CRLF);
    }

    public static void print(String tar, boolean b) {
        prinT(tar, b + "");
    }

    public static void println(String tar, boolean b) {
        prinT(tar, b + CRLF);
    }

    public static void print(String tar, Object o) {
        prinT(tar, o + "");
    }

    public static void println(String tar, Object o) {
        prinT(tar, o + CRLF);
    }
    ...
    private static void prinT(String tar, Object str) {
        ...
        if ((tar.equals("LPT1")) || (tar.equals("LPT2"))
            ...
            tar = tar.trim();
            if (tar.length() > 0) {
                fileWriteString2(tar, text);
            }
        } else if (tar.indexOf("ADD:") == 0) {
            tar = tar.substring(4);
            tar = tar.trim();
            if (tar.length() > 0) {
                fileAppendString(tar, text);
            }
      ...
      try {
         out= new PrintWriter(new OutputStreamWriter(System.out, codePage));
         out.print(str.toString());  out.flush();  // toString() ist unnötig
...
*/
    ...
    /**
     * Gibt text mit max. width Zeichen pro Zeile linksbündig aus.
     */
    ...
    /**
     * Gibt text mit max. width Zeichen pro Zeile linksbündig aus.  xPos = linker Rand
     */
    ...
    /* Formatiert text mit maximal width Zeichen pro Zeile linksbündig. */
    //public static String formatText(String text, int width)
    //{ return  formatText(text, width, 0); }

    /**
     * Formatiert text mit linkem Rand xPos. - Fügt vor jeder Zeile xPos Leerzeichen ein.
     */
    ...
    /**
     * Formatiert text mit linkem Rand xPos.  xPosChar = Rand-Füll-Zeichen.
     */
    public static String formatTextPos(String text0, int xPos, char xPosChar) {
        //int xPos2 = (int)xPos;
        String leerZ = "";
        String text2 = text0;
        if ((text2 == null) || (text2.length() == 0) || (xPos < 0)) {
            return "";
        }
        for (int i = 0; i < xPos; i++) {
            leerZ = leerZ + xPosChar;
        }
        text2 = leerZ + text2;
    ...
    /* Formatiert text mit maximal width Zeichen pro Zeile linksbündig.  xPos = linker Rand */
    ...
    /**
     * Schreibt String in Text-Datei und gibt bei Erfolg true zurück.
     */
    public static boolean fileWriteString2(String datei, String text) {
        ...
        try {
            ...
            out.write(text);
            out.close();  // schreibe und schließe Datei
        } catch (IOException e) {
            System.err.println(e);
            return false;
        }
        return true;  // Rückgabe von true, wenn Schreibvorgang erfolgreich.
    }
   ...
   */
    ...
    /**
     * Hängt Text an eine Text-Datei und gibt bei Erfolg true zurück.
     */
    ...
    /**
     * Erzeugt eine neue Datei mit Leer-String "" und gibt bei Erfolg true zurück.
     */
    public static boolean fileMake(String datei) {
        return fileWriteString2(datei, "");
    }

    /**
     * Löscht Datei und gibt bei Erfolg true zurück.
     */
   ...
   */
    ...
    /**
     * Überprüft, ob die Datei gelesen werden kann.
     */
    ...
    /**
     * Überprüft, ob die Datei geschrieben werden kann.
     */
    ...
    /**
     * Überprüft, ob datei eine Datei ist.
     */
    ...
    /**
     * Überprüft, ob datei ein Verzeichnis ist.
     */
    ...
    /**
     * Überprüft, ob datei versteckt (hidden) ist.
     */
    ...
    /**
     * Gibt den Pfad ausgehend von der Wurzel zurück.
     */
    ...
    /**
     * Zeit der letzten Änderung in Millisekunden ab dem 1. Januar 1970.  0 bei Fehler
     */
    ...
    /**
     * Erzeugt eine neue Datei und gibt bei Erfolg true zurück.
     */
    public static boolean fileNewFile(String datei) {
        try {
            return (new File(fileSep(datei))).createNewFile();
        } catch (IOException e) {
    ...
    /**
     * Gibt das Arbeitsverzeichnis zurück.
     */
    ...
    /**
     * Datei umbenennen und bei Erfolg true zurückgeben.
     */
     ...
     */
    public static String cls() {//MMMMMMMMMMMMMMMMMMMMMMM
    ...
    /**
     * Cursor zum Zeilen-Anfang + löschen  (ohne Ansi.sys)
     */
     ...
     */
    public static long time() {//MMMMMMMMMMMMMMMMMMMMMM
     ...
     */
    public static long timeSec() {//MMMMMMMMMMMMMMMMMMMMMMMMM
     ...
     */
    public static String soundStop() {
        if (clip != null) {
            clip.stop();
        }
        return "";
     ...
     */
    public static String soundLoop() {
        if (clip != null) {
            clip.loop();
        }
        return "";
     ...
     * Java 1.2 unterstützt z.B. Audio (AIFF, AU, WAV) und
     * MIDI (Type0 MIDI, Type1 MIDI, RMF)
     */
    public static String sound(String datei) {
        sound(datei, 1);
        return "";
    }
    ...
    public static String sound(String datei, long dauer) {
         ...
         */
            try {
                URL url = new URL("file:///" + datei);  // getAudioClip lädt nicht
                clip = Applet.newAudioClip(url);
                if (dauer > 0) {
                    clip.play();
                }
                try {
                    Thread.sleep(Math.abs(dauer) * 1000);
            ...
            clip = null;
            println("Datei:  " + datei + "  nicht gefunden!");
            beep(2);
        }
        return "";
    }
...
*/
    ...
    /**
     * n Pieps-Töne ausgeben und jeweils 500ms warten
     */
    ...
    /**
     * Zeichen nach links löschen "\b \b"
     */
    ...
    /**
     * n Zeichen nach links löschen "\b \b..."
     */
    ...
    public static int getDay() {
        return getDate(Calendar.DAY_OF_MONTH);
    }
    ...
    public static int getWeekDay() {
        return getDate(Calendar.DAY_OF_WEEK);
    }
    ...
    public static int getYearDay() {
        return getDate(Calendar.DAY_OF_YEAR);
    }
    ...
    public static int getWeek() {
        return getDate(Calendar.WEEK_OF_YEAR);
    }
    ...
    public static int getMinute() {
        return getDate(Calendar.MINUTE);
    }
    ...
    public static int getSecond() {
        return getDate(Calendar.SECOND);
    }
    ...
    public static int getMilliSecond() {
        return getDate(Calendar.MILLISECOND);
    }
    ...
    public static byte randomByte() {
        return (byte) Math.round(random(Byte.MIN_VALUE, Byte.MAX_VALUE));
    }

    public static short randomShort() {
        return (short) Math.round(random(Short.MIN_VALUE, Short.MAX_VALUE));
    }

    public static int randomInt() {
        return (int) Math.round(random(Integer.MIN_VALUE, Integer.MAX_VALUE));
    }

    public static long randomLong() {
        return Math.round(random(Long.MIN_VALUE, Long.MAX_VALUE));
    }

    public static float randomFloat() {
        return (float) random(Float.MIN_VALUE, Float.MAX_VALUE);
    }
     ...
     */
    public static byte randomByte(double max) {
        return (byte) Math.round(random(0, max));
    }

    public static short randomShort(double max) {
        return (short) Math.round(random(0, max));
    }
    ...
    public static long randomLong(double max) {
        return Math.round(random(0, max));
    }

    public static float randomFloat(double max) {
        return (float) random(0, max);
    }
    ...
    public static char randomChar(double max) {
        return (char) random(0, max);
    } //Character.MAX_VALUE=65540

    public static String randomString(int laenge) {
        return randomString(laenge, 32, 255);
    }
    ...
    public static String randomString(int laenge, double min, double max) {
        if (max == 0) {
            ...
            int sLenge = Math.abs(laenge);
            StringBuffer sBuf = new StringBuffer(sLenge);
            for (int i = 0; i < sLenge; i++) {
                sBuf.append(randomChar(min, max));
            }
     ...
     */
    public static byte randomByte(double min, double max) {
        return (byte) Math.round(random(min, max));
    }

    public static short randomShort(double min, double max) {
        return (short) Math.round(random(min, max));
    }
    ...
    public static char randomChar(double min, double max) {
    ...
    /**
     * n! -- Fakultät von n (n=[0..23]) Bei Fehler wird -1 zurückgegeben.
     */
    ...
    /**
     * n! -- Fakultät von n (n=[0..170]) Bei Fehler wird -1 zurückgegeben.
     */
     ...
     */
    public static double mathLog(double zahl, double base) {
        return Math.log(zahl) / Math.log(base);
    }  // Logarithmus zur Basis base

    /**
     * Logarithmus von zahl zur Basis 10
     */
    public static double mathLog10(double zahl) {
        return Math.log(zahl) / Math.log(10);
    }  // lg() Logarithmus zur Basis 10

    /**
     * Logarithmus von zahl zur Basis e -- natürlicher Logarithmus wie ln(?)
     */
    public static double mathLogE(double zahl) {
        return Math.log(zahl);
    }               // ln() Logarithmus zur Basis e

    /**
     * Logarithmus von zahl zur Basis e -- natürlicher Logarithmus wie logE(?)
     */
    public static double mathLn(double zahl) {
        return Math.log(zahl);
    }               // ln() Logarithmus zur Basis e
     ...
     */
    public static double mathLg(double zahl) {
        return Math.log(zahl) / Math.log(10);
    }  // lg() Logarithmus zur Basis 10
     ...
     */
    public static double mahtPow(double base, double exp) {
     ...
     */
    public static double mathPowE(double exp) {
        return Math.pow(Math.E, exp);
    } // oder Math.exp(exp)  // basis hoch e

    /**
     * power - Potenz-Funktion:  e hoch exp (entspricht Math.powE(exp)
     */
    public static double mathExp(double exp) {
        return Math.exp(exp);
    } // oder Math.exp(exp)  // basis hoch e
     ...
     */
    public static double mahtPow2(double exp) {
     ...
     */
    public static double mahtPow10(double exp) {
     ...
     */
    public static double mahtRoot(double radikant, double wExp) {
        return Math.pow(radikant, 1.0 / wExp + 0.0);
    }  // n-te Wurzel von radikant

    /**
     * Wurzel-Funktion: e-te Wurzel aus radiant
     */
    public static double mahtRootE(double radikant) {
        return Math.pow(radikant, 1.0 / Math.E);
    } // e-te Wurzel aus radikant

    /**
     * Wurzel-Funktion: Quadrat-Wurzel aus radiant = square-root  wie root2(?))
     */
    public static double mahtSqrt(double radikant) {
     ...
     */
    public static double mahtRoot2(double radikant) {
        return Math.sqrt(radikant);
    }             // Quadrat-Wurzel  / square-root
     ...
     */
    public static double mahtRoot3(double radikant) {
        return Math.pow(radikant, 1.0 / 3.0);
    }    // Kubik-Wurzel    / cube-root

    /**
     * Wurzel-Funktion: 10. Wurzel aus radiant
     */
    public static double mahtRoot10(double radikant) {
        return Math.pow(radikant, 1.0 / 10.0);
    }   // 10-te Wurzel
     ...
     */
    public static double mahtCot(double a) {
     ...
     */
    public static double pythagorasB(double c, double a) {
        return pythagorasA(c, a);
    }
    ...
    public static double pythagorasA(double c, double b) {
        if ((c <= 0) || (b <= 0) || (c == b)) {
            println("PythagorasAB-ERROR!");
            return -1;
        } else {
            return Math.sqrt(Math.abs(c * c - b * b));
        }
    }
    ...
    /**
     * Höhensatz:  h²= p*q  -  h wird berechnet.
     */
    public static double pythagorasH(double p, double q) {
        if ((p <= 0) || (q <= 0)) {
            println("PythagorasH-Fehler!");
            return -1;
        } else {
    ...
    /**
     * Höhensatz:  h²= p*q  -  q wird berechnet.
     */
    public static double pythagorasQ(double h, double p) {
        if ((h <= 0) || (p <= 0)) {
            println("PythagorasQ-Fehler!");
            return -1;
        } else {
            return (h * h / p);
        }
    ...
    /**
     * Höhensatz:  h²= p*q  -  p wird berechnet.
     */
    public static double pythagorasP(double h, double q) {
        if ((h <= 0) || (q <= 0)) {
            println("PythagorasP-Fehler!");
            return -1;
        } else {
            return (h * h / q);
        }
    ...
    public static double pythagoras(double a, double b, double c) {
        if ((a <= 0) && (b > 0) && (c > 0) && (b < c)) {
            return pythagorasA(b, c);
        }  //&&(b<c)
        else if ((b <= 0) && (a > 0) && (c > 0) && (a < c)) {
            return pythagorasB(a, c);
        } else if ((c <= 0) && (a > 0) && (b > 0)) {
            return pythagorasC(a, b);
        } else {
            println("Pythagoras-Fehler!");
            return -1;
        }
    }
   /* Pythagoräische Zahlen:   3    4    5    (a, b, c)
                               6    8   10
                              12   16   20    usw.
   */
...
/// Bei Windows NT funktioniert's angeblich nicht!? .... unter Linux schon!? ///
    ...
    /**
     * Ganzzahlige Farb-Konstanten für Ansi.SYS-Anzeige
     */
     ...
     */
    public static int ansiGetTextColor() {
        return tColor;
    }
     ...
     */
    public static int ansiGetBackColor() {
        return bColor;
    }
     ...
     */
    public static int ansiGetTextAttribute() {
        return tAttribute;
    }
    ...
    /**
     * Auf Schwarz/Weiß bzw. Normal-Darstellung umschalten.  (Ansi.sys)
     */
    ...
    public static String ansiSetColors(int tCol, int bCol) {
        if ((tCol >= 0) && (tCol <= 7) && (bCol >= 0) && (bCol <= 7)) {
            tColor = tCol;
            bColor = bCol + 10;
            ansiSetBackColor(bColor);
            ansiSetTextColor(tColor);
        }
        return "";
    }
    ...
    public static String ansiGoToXY(int x, int y) {
        ...
        /* außerhalb des gültigen Bereichs wird ignoriert */
     ...
     */
    public static String ansiMoveXY(int x, int y) {
        ansiMoveX(x);
        ansiMoveY(y);
        return "";
    }
    ...
    static { // Block für statische Initialisierungen = Konstruktor für statische Klassen?
     ...
     * Cursor nach rechts  (Ansi.sys)
     */
    public static String ansiRight() {
        ansiMoveX(1);
        return "";
    }
     ...
     */
    public static String ansiBottom() {
        ansiMoveY(2222);
        return "";
    }
     ...
     */
    public static String ansiClrScr() {
        System.out.print("\u001B[2J");
        ansiGoToXY(0, 0);
        return "";
    }
     ...
     */
    public static String ansiClrScr(int bColor) {
        ansiSetBackColor(bColor);
        ansiClrScr();
        return "";
    }
     ...
     * ClearScreen mit HintergrundFarbe  (Ansi.sys)
     */
    public static String ansiClrScr(String bColor) {
        print(bColor);
        ansiClrScr();
        return "";
    }
    ...
    /**
     * Löschen bis zum Zeilen-Ende  (Ansi.sys)
     */
    public static String ansiClrEol() {
        System.out.print("\u001B[K");
        return "";
    }

    /**
     * Zeile löschen  (Ansi.sys)
     */
    public static String ansiClrLine() {
        ansiMoveXY(-2222, 0);
        ansiClrEol();
        return "";
    }
     ...
     */
    public static String ansiGetPos() {
        System.out.print("\u001B[6n");
        return "";
    }
     ...
     */
    public static String ansiSaveCursor() {
        System.out.print("\u001B[s");
        return "";
    }
     ...
     */
    public static String ansiRestoreCursor() {
        System.out.print("\u001B[u");
        return "";
    }

    /**
     * +/-number Zeilen unter-/oberhalb der Cursorposition löschen. (Ansi.sys)
     */
    ...
    /**
     * Ab Cursorposition bis zum Seiten-Ende löschen. (Ansi.sys)
     */
    public static String ansiClrDown() {
        return ansiClrLines(33);
    }

    /**
     * Ab Cursorposition bis zum Seiten-Anfang löschen. (Ansi.sys)
     */
    public static String ansiClrUp() {
        return ansiClrLines(33);
    }
    ...
    /**
     * Ausgabe-Umleitung auf Konsole zurücksetzen. - siehe: setSystemOut()
     */
    public static boolean resetSystemOut() {
        return setSystemOut("CON");
    }

    /**
     * Ausgabe-Umleitung auf Konsole zurücksetzen.
     */
    public static boolean setSystemOut() {
        return setSystemOut("CON");
    }
    ...
    public static boolean setSystemOut(String dName) {
        ...
        System.out.close();
        try {
            System.setOut(new PrintStream(new FileOutputStream(dName)));
        } catch (FileNotFoundException e) {
            resetSystemOut();
            System.err.println(e.toString());
            return false;
    ...
    /**
     * Fehler-Umleitung auf Konsole zurücksetzen. - siehe: setSystemErr()
     */
    public static boolean resetSystemErr() {
        return setSystemErr("CON");
    }

    /**
     * Fehler-Umleitung auf Konsole zurücksetzen.
     */
    public static boolean setSystemErr() {
        return setSystemErr("CON");
    }
    ...
    public static boolean setSystemErr(String dName) {
        ...
        System.err.close();
        try {
            System.setErr(new PrintStream(new FileOutputStream(dName)));
        } catch (FileNotFoundException e) {
            resetSystemErr();
            System.err.println(e.toString());
            return false;
    ...
    /**
     * Eingabe-Umleitung auf Konsole zurücksetzen. - siehe: setSystemIn()
     */
    public static boolean resetSystemIn() {
        return setSystemIn("CON");
    }

    /**
     * Eingabe-Umleitung auf Konsole zurücksetzen.
     */
    public static boolean setSystemIn() {
        return setSystemIn("CON");
    }
    ...
    public static boolean setSystemIn(String dName) {
        //System.in.close();
        try {
            System.setIn(new FileInputStream(dName));
        } catch (FileNotFoundException e) {
            resetSystemIn();
            System.err.println(e.toString());
            return false;
     ...
     */
    public static String toChar(int ch) {
        return ((char) ch + "");
    }
     ...
     */
    public static String printChar(int ch) {
        print((char) ch);
        return "";
    }
    ...
    /**
     * Alle oldStr in text0 löschen bzw. durch "" ersetzen.
     */
    ...
    /**
     * n-mal oldStr in text0 löschen bzw. durch "" ersetzen.
     */
    ...
    public static String stringReplace(String text0, String oldStr, String newStr) {
        String text = text0;
        if ((text.length() == 0) || (oldStr.length() == 0)) {
            return text;
        }
    ...
    public static String stringReplace(String text0, String oldStr, String newStr, int n) {
        String text = text0;
        if ((text == null) || (text.length() == 0) || (oldStr.length() == 0)) {
            return text;
        }
        StringBuffer strBuf = new StringBuffer(text);
        int pos = text.indexOf(oldStr);
    ...
    /**
     * Anzahl der Vorkommen von search in text0 zählen.
     */
    public static int stringCount(String text0, String search) {
        String text = text0;
        if ((text == null) || (text.length() == 0) || (search == null)) {
            return 0;
        }
        int count = 0;
        StringBuffer strBuf = new StringBuffer(text);
    ...
    /**
     * Anzahl der Vorkommen von search in text0 zählen. Groß/kein ignorieren
     */
    ...
    /**
     * Prüft, ob text mit ende endet. - case-sensetive
     */
    public static boolean stringEndsWith(String text, String ende) {
        if ((text == null) || (ende == null) || (text.length() < ende.length())) {
            return false;
        } else {
            return text.startsWith(ende, text.length() - ende.length());
        }
    }

    /**
     * Prüft, ob text mit ende endet. - case-insensetive
     */
    ...
    /**
     * Prüft, ob text mit start beginnt. case-sensetive
     */
    ...
    /**
     * Gibt text mit max. width Zeichen pro Zeile rechtsbündig aus.
     */
    ...
    /**
     * Gibt text mit max. width Zeichen pro Zeile rechtsbündig aus.  xPos = linker Rand
     */
    ...
    /**
     * Formatiert text mit maximal width Zeichen pro Zeile rechtsbündig.  xPos = linker Rand
     */
    ...
    private static String formatTextLCR(String text, int xPos, int width, int align) {
        if ((text == null) || (text.length() == 0) || (width <= 0) || (xPos < 0)) {
            return "";
        }
    ...
    public static boolean fileWriteBoolean(String datei, long pos, boolean[] werte) {
        ...
        for (int i = 0; i < werte.length; i++) {
            ret = fileWGZ(datei, pos + i, werte[i] ? 1 : 0, BOOLEAN0_SIZE);
        }
        return ret;
    }
    ...
    public static boolean fileWriteChar(String datei, long pos, char[] werte) {
        boolean ret = false;
        for (int i = 0; i < werte.length; i++) {
            ret = fileWGZ(datei, pos + i, werte[i], CHAR0_SIZE);
        }
        return ret;
    }
    ...
    public static boolean fileWriteByte(String datei, long pos, byte[] werte) {
        boolean ret = false;
        for (int i = 0; i < werte.length; i++) {
            ret = fileWGZ(datei, pos + i, werte[i], BYTE_SIZE);
        }
        return ret;
    }
    ...
    public static boolean fileWriteShort(String datei, long pos, short[] werte) {
        boolean ret = false;
        for (int i = 0; i < werte.length; i++) {
            ret = fileWGZ(datei, pos + i, werte[i], SHORT_SIZE);
        }
        return ret;
    }
    ...
    public static boolean fileWriteInt(String datei, long pos, int[] werte) {
        boolean ret = false;
        for (int i = 0; i < werte.length; i++) {
            ret = fileWGZ(datei, pos + i, werte[i], INT_SIZE);
        }
        return ret;
    }
    ...
    public static boolean fileWriteLong(String datei, long pos, long[] werte) {
        boolean ret = false;
        for (int i = 0; i < werte.length; i++) {
            ret = fileWGZ(datei, pos + i, werte[i], LONG_SIZE);
        }
        return ret;
    }
    ...
    public static boolean fileWriteFloat(String datei, long pos, float[] werte) {
        boolean ret = false;
        for (int i = 0; i < werte.length; i++) {
            ret = fileWGZ2(datei, pos + i, werte[i], FLOAT_SIZE);
        }
        return ret;
    }
    ...
    public static boolean fileWriteDouble(String datei, long pos, double[] werte) {
        boolean ret = false;
        for (int i = 0; i < werte.length; i++) {
            ret = fileWGZ2(datei, pos + i, werte[i], DOUBLE_SIZE);
        }
        return ret;
    }
    ...
    public static boolean fileWriteBoolean(String datei, boolean wert) {
        return fileWGZ(datei, 0, wert ? 1 : 0, BOOLEAN0_SIZE);
    }
    ...
    public static boolean fileWriteBoolean(String datei, long pos, boolean wert) {
        return fileWGZ(datei, pos, wert ? 1 : 0, BOOLEAN0_SIZE);
    }
        ...
        try {
            if (!lastWFile.equalsIgnoreCase(datei)) {
                try {
                    ...
                    ;
                }  //System.out.println("Fehler:10" + e.toString()); }
                wRaf = new RandomAccessFile(datei, "rw");
                lastWFile = datei;
            }
            if (pos >= wRaf.length()) {
                wRaf.setLength(pos + typ);
            }
            if ((pos <= wRaf.length()) && (pos >= 0)) {
                wRaf.seek(pos);
                switch (typ) {
                    case BOOLEAN0_SIZE: {
                        wRaf.writeBoolean(wert == 1 ? true : false);
                        ret = true;
                        break;
                    }
                    case CHAR0_SIZE: {
                        wRaf.writeChar((char) wert);
                        ret = true;
                        break;
                    }
                    case BYTE_SIZE: {
                        wRaf.writeByte((byte) wert);
                        ret = true;
                        break;
                    }
                    case SHORT_SIZE: {
                        wRaf.writeShort((short) wert);
                        ret = true;
                        break;
                    }
                    case INT_SIZE: {
                        wRaf.writeInt((int) wert);
                        ret = true;
                        break;
                    }
                    case LONG_SIZE: {
                        wRaf.writeLong((long) wert);
                        ret = true;
                        break;
                    }
                    default: {
                ...
                System.out.println("Write-FEHLER! " + datei);
                ret = false;
            }
            return ret;
        } catch (Exception e) {
            System.out.println("Fehler:11" + datei + ": " + e.toString());
            return false;
        }
    }
        ...
        try {
            if (!lastWFile.equalsIgnoreCase(datei)) {
                try {
                    ...
                    System.out.println("Fehler:20" + e.toString());
                }
                wRaf = new RandomAccessFile(datei, "rw");
                lastWFile = datei;
            }
            ...
            if ((pos <= wRaf.length()) && (pos >= 0)) {
                ...
                switch (typ) {
                    case FLOAT_SIZE: {
                        wRaf.writeFloat((float) wert);
                        ret = true;
                        break;
                    }
                    case DOUBLE_SIZE: {
                        wRaf.writeDouble((double) wert);
                        ret = true;
                        break;
                    }
                    default: {
            ...
            System.out.println(datei + ": " + e.toString());
            return false;
        }
    }
    ...
    public static boolean[] fileReadBoolean(String datei, long pos, int n) {
        ...
        for (int i = 0; i < n; i++) {
            intArr[i] = fileReadBoolean(datei, pos + i);
        }
        return intArr;
    }
    ...
    public static char[] fileReadChar(String datei, long pos, int n) {
        ...
        for (int i = 0; i < n; i++) {
            intArr[i] = fileReadChar(datei, pos + i);
        }
        return intArr;
    }
    ...
    public static byte[] fileReadByte(String datei, long pos, int n) {
        ...
        for (int i = 0; i < n; i++) {
            intArr[i] = fileReadByte(datei, pos + i);
        }
        return intArr;
    }
    ...
    public static short[] fileReadShort(String datei, long pos, int n) {
        ...
        for (int i = 0; i < n; i++) {
            intArr[i] = fileReadShort(datei, pos + i);
        }
        return intArr;
    }
    ...
    public static int[] fileReadInt(String datei, long pos, int n) {
        ...
        for (int i = 0; i < n; i++) {
            intArr[i] = fileReadInt(datei, pos + i);
        }
        return intArr;
    }
    ...
    public static long[] fileReadLong(String datei, long pos, int n) {
        ...
        for (int i = 0; i < n; i++) {
            intArr[i] = fileReadLong(datei, pos + i);
        }
        return intArr;
    }
    ...
    public static float[] fileReadFloat(String datei, long pos, int n) {
        ...
        for (int i = 0; i < n; i++) {
            intArr[i] = fileReadFloat(datei, pos + i);
        }
        return intArr;
    }
    ...
    public static double[] fileReadDouble(String datei, long pos, int n) {
        ...
        for (int i = 0; i < n; i++) {
            intArr[i] = fileReadDouble(datei, pos + i);
        }
        return intArr;
    }
            ...
            try {
                if (!lastRFile.equalsIgnoreCase(datei)) {
                    try {
                        ...
                        ;
                    } //System.out.println("Fehler:100" + e.toString()); }
                    rRaf = new RandomAccessFile(datei, "r");  // Datei öffnen, falls geschlossen.
                    lastRFile = datei;
                }
                if ((pos >= 0) && (pos < rRaf.length())) {
                    ...
                    System.out.println("Read-FEHLER: " + datei);
                    ret = min;
                }
                return ret;  // rRaf.close();
            } catch (Exception e) {     //EOFExceptionnull
                System.out.println("Fehler:101" + datei + ": " + e.toString());
                return -1;
            }  // bei falschem seek - Bad file-descriptor IOException
        } else {
            System.out.println(datei + " not found!");
            ret = min;
        }
        return min;
    }
    ...
    /**
     * String-Array an den Datei-Anfang schreiben.  Fehler-Rückgabe: -1 ra
     */
    ...
    /**
     * String-Array in eine Datei schreiben.  pos = Dateiposition; Fehler-Rückgabe: -1
     */
    ...
    /**
     * String an den Datei-Anfang schreiben.  Fehler-Rückgabe: -1  ra
     */
    ...
    /**
     * String in eine Datei schreiben.  pos = Dateiposition; Fehler-Rückgabe: -1 ra
     */
            ...
            try {
                if (!lastWFile.equalsIgnoreCase(datei)) {
                    try {
                        ...
                        System.out.println("Fehler:30" + e.toString());
                    }
                    wRaf = new RandomAccessFile(datei, "rw");
                    lastWFile = datei;
                }
                while (wRaf.readLine() != null) {
                    ++zeilen;
                }
                if (pos >= zeilen) {
                    wRaf.setLength(wRaf.length() + wert.length() + 1);
                } // read
                if (pos >= 0) {
                    wRaf.seek(pos);
                    wRaf.writeBytes(wert);
                    ret = pos;  // ersetzen
    ...
    /**
     * n Zeilen vom Datei-Anfang lesen.  Fehler-Rückgabe: -1 ra
     */
    ...
    /**
     * n Zeilen aus einer Datei lesen.  pos = Dateiposition; Fehler-Rückgabe: -1 ra
     */
    public static String[] fileReadString(String datei, long pos, int n) {
        String[] strArr = new String[n];
        for (int i = 0; i < n; i++) {
            strArr[i] = fileReadString(datei, pos + i);
        }
        return strArr;
    }

    /**
     * String vom Datei-Anfang lesen.  Fehler-Rückgabe: -1 ra
     */
    ...
    /**
     * String aus einer Datei lesen.  pos = Dateiposition;  Fehler-Rückgabe: -1 ra
     */
        ...
        try {
            if (!lastRFile.equalsIgnoreCase(datei)) {
                try {
                    ...
                    System.out.println("Fehler:40" + e.toString());
                }
                rRaf = new RandomAccessFile(datei, "r");
                lastRFile = datei;
            }
            rRaf.seek(0);
            if (pos >= 0) {
                ...
                String strBak;                //writeChars(String)
                StringBuilder strB = new StringBuilder(); //rRaf.length());
    ...
    public static void fileCloseAll() {
        try {
            ...
            System.out.println("Fehler:55" + e.toString());
        }
        try {
            lastWFile = "";
            wRaf.close();
            ...
            System.out.println("Fehler:56" + e.toString());
        }
    }

    /**
     * Erzeugt neue Datei mit size-Größe.
     */
    ...
    // imbort java.awt.*; Achtung!!!! Auskommentierung genügt nicht!
    // public static void beep()  { Toolkit.getDefaultToolkit().beep(); }

    /**
     * GanzZahl mit der Breite width ausgeben.  -width = linksbündig
     */
    public static void printLong(long zahl, int width) {
        printString(Long.toString(zahl), width);
    }    //(new Long(zahl)).toString()
    ...
    /**
     * KommaZahl mit der Breite width ausgeben.  -width = linksbündig
     */
    public static void printDouble(double zahl, int width) {
        printString(Double.toString(zahl), width);
    }    //(new Long(zahl)).toString()
    ...
    /**
     * KommZahl formatiert mit der Breite width ausgeben.  -width = linksbündig
     */
    ...
    /**
     * String mit der Breite width ausgeben.  -width = linksbündig
     */
    ...
    public static void printString(String str, int width) {
        if (width > 0) {  //rechtsbündig
            for (int i = str.length(); i < width; i++) {
                str = " " + str;
            }
        } else if (width < 0) {  //linksbündig
            width = Math.abs(width);
            for (int i = str.length(); i < width; i++) {
                str = str + "_";
            }
     ...
     */
    public static void exit() {//MMMMMMMMMMMMMMMMMMMMMM
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 14; i = i + 2) {
            Kon.printTextCenter("(-: Java für Einsteiger :-) www.grabler.de\n\n", i, 30);
        }
    }
}
...
Es ist natürlich immer aufwändig für einen einfachen 10cpi Text ein Printer
Objekt zu erzeugen und dann all den Text als Grafik zu erzeugen. Das braucht
nicht nur lange, sondern ist auch sehr umständlich. Um einen Drucker am Par-allelport
...
pw.close();
Hängt dann am Printer Port ein Drucker, so schreiben wir den Text in den
...
werden.
Natürlich sehen wir auf den ersten Blick, dass dies eine Windows/DOS Ver-sion
ist. Um das Ganze auch systemunabhängig zu steuern, entwickelte Sun die
Communications API. Obwohl sie in erster Linie für die serielle Schnittstelle
gedacht ist, unterstützt sie auch die parallele Schnittstelle. Hier bietet sich auch
die Chance, den Zugriff zu synchronisieren. Fünf willige Druckerbenutzer
...
dass das Konzept nicht besonders plattformunabhäng ist. Wenn wir
einen Macintosh als Plattform betrachten, dann lässt sich dort keine Konsole
ausmachen. Bei GUI-Anwendungen spricht demnach einiges dafür, auf die
Konsolenausgabe zu verzichten und die Ausgabe in ein Fenster zu setzen. Ich
möchte daher an dieser Stelle etwas vorgreifen und ein Programmstück vorstel-len,
mit dem sich die Standard-Ausgabeströme in einem Fenster darstellen las-sen.
Dann genügt folgendes, unter der Annahme, dass die Variable ta ein
...
Ging alles gut, wird true zurückgegeben.
w boolean delete()
true, wenn Datei gelöscht werden konnte. Ein zu löschendes Verzeichnis muss
leer sein. Diese Methode löscht wirklich. Sie ist nicht so zu verstehen, dass sie
true liefert, falls die Datei potenziell gelöscht werden kann.
class java.io.File
implements Serializable, Comparable

Sicherheitsprüfung
Wir müssen uns bewusst sein, dass verschiedene Methoden, unter der Bedin-gung,
dass ein Security-Manager die Dateioperationen überwacht, eine Secu-rityException
auslösen können. Security-Manager kommen beispielsweise
bei Applets zum Zuge. Folgende Methoden sind Kandidaten für eine Securi-tyException:
...
und renameFile().
   ...
   //public static void println(double[] d)  { prinT (d + "\n"); }
      ...
      tp.beep();
      System.out.prSystem.out.println( );intln("Auflösung: " + tp.getScreenResolution);
